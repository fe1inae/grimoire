document {
	...
	p {
		...
		"perhaps most humorously",
		url("https://datatracker.ietf.org/doc/html/rfc2549", "RFC 2549"),
	...
	p "XXX (i got bored, more schizorants to come)",
	...
	tree {
		...
		url("https://bootstrapping.miraheze.org/wiki/Main_Page"),
		url("https://wiki.xxiivv.com/site/collapse_computing.html"),
	},
}
