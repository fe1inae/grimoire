(page (title "scattered schizo rambles about ideal text interface")
      (list "take from:"
            (list :acme
                  (list "can execute anything"
                        "take from `win` thing, minimal terminal esque interface")
                  :kak
                  (list "modal editing" "wd not dw"
                  ...
                  :vim
                  (list "more modal-y than kakoune, viw vs A-i w for example. or something even more concise, but in general prefer modes over modifier keys."
                  ...
                  "idk misc"
                  (list "ctrl+f or whatever its called, select words that match a predefined regex"
      ...
      "need to emphazise that the " (bold :core)
      " does not include many of these fancier features, what is in the core/scripted im not entirely sure yet but the core will be as small as possible.")
